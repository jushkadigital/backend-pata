...
public class HomeResource {
  ...
  /**
   * Returns the ID Token info. This endpoint exists only for demonstration
  ...
  /**
   * Returns the Access Token info. This endpoint exists only for demonstration
   * purposes, you should not
   * expose this token in a real application.
   *
  ...
  public String getAccessTokenInfo() {
    ...
    response.append("<h3>You are accessing the application within tenant BEARRR BEARER <b>")
        .append(accessToken.getIssuer())
        .append(accessToken.getRawToken())
        .append(" boundaries</b></h3>");
